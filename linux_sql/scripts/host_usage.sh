...
disk_io=$(vmstat -d | awk '{print $10}' .| awk '{print $4}'| tail -n1 | xargs)
...
* * * * * /home/centos/Desktop/project/jarvis_data_eng_BarshaMagar/linux_sql/scripts/host_usage.sh localhost 5432 host_agent postgres password > /tmp/host_usage.log
